...
點擊下方按鈕可以直接 clone 原始專案並部署到 Vercel：
...
> 💡 **如果你已經 fork 了專案**：  
> 請修改你 fork 的 README.md，將上方按鈕的連結改為：  
> `https://vercel.com/new/clone?repository-url=https://github.com/你的用戶名/linebot-gemini-file-search`
>
> 或者直接使用**方式二（GitHub 連接）**，這樣更適合已 fork 的專案。
>
